...
xdescribe(`${PromiseClass.name} Execution Sequence Tests`, () => {
    // This case always failed because MyPromise uses process.nextTick to call next callback in case of resolved promise
